...
export default function ChatbotWidget() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { 
      id: "init", 
      role: "model", 
      content: "สวัสดีครับ! ผมชื่อ **น้องบอท** ผู้ช่วยสอนวิชาโปรแกรมฐานข้อมูล ยินดีตอบข้อสงสัย แนะนำคำสั่ง SQL และเทคนิคการเรียนให้ครับ มีอะไรให้ช่วยสอบถามได้เลยครับ! 🤖✨",
      timestamp: "ตอนนี้"
    }
  ]);
